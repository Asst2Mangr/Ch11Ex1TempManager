...
namespace Ch11Ex1TempManager.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            if (TempData["okDate"] == null)
            {
                string msg = ValidationController.DateExists(data,temp.Date.ToString());
                if (msg != null)
                {
                    ModelState.AddModelError(nameof(Temp.Date), msg);   
                }
            }
